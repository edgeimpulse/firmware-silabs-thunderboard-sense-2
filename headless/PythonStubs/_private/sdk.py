...
#
#	Generated from com.silabs.ss.platform.api.sdk.core.scripting.ISLSSDKModule 
#	API version 0
#

class sdk(com_silabs_ss_platform_api_scripting_core_ISLSManagerModuleBase):
  '''
  This module provides access to the Studio SDKs
   *
  '''
  NAME = str
  '''
  ...
  def isCompatibleWithPart(self, sdk, part):
    '''
    Checks if this sdk is compatible with the given part
    @param sdk a str, Descriptor, or Entity to match against the part
    @param part a str, Descriptor, or Entity to match against the sdk
    @type sdk: object
    @type part: object
    @return True if the sdk and part are compatible, False otherwise
    '''
    return bool()


  def isCompatibleWithSDK(self, sdk, matchedSDK):
    '''
    Check if the two sdks are compatible with each other
    @param sdk a str, Descriptor, or Entity to match with the other sdk
    @param matchedSDK a str, Descriptor, or Entity to match with the other sdk
    @type sdk: object
    @type matchedSDK: object
    @return True if the two sdks are compatible, False otherwise
    '''
    return bool()
