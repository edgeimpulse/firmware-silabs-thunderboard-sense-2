...
#
#	Generated from com.silabs.ss.platform.api.content.part.core.scripting.ISLSPartModule 
#	API version 0
#

class part(com_silabs_ss_platform_api_scripting_core_ISLSManagerModuleBase):
  '''
  This module provides access to Studio parts.
   *
  '''
  NAME = str
  '''
  ...
  def isCompatibleWithPart(self, part, matchedPart):
    '''
    Checks if the two parts are compatible with each other
    @param part a str, Descriptor, or Entity to match with the other part
